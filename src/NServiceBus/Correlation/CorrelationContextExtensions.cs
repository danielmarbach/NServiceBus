namespace NServiceBus
{
    ...
    public static class CorrelationContextExtensions
    {
        ...
        [Obsolete("Setting a custom correlation ID is discouraged and will be removed in the next major version.")]
        ...
        [Obsolete("Using custom correlation IDs is discouraged and will be removed in the next major version.")]
