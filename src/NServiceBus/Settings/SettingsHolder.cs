namespace NServiceBus.Settings
{
    ...
    public partial class SettingsHolder : ReadOnlySettings
    {
        ...
        void EnsureMergingIsPossible()
        {
            if (locked)
            {
                throw new InvalidOperationException("Unable to merge settings. The settings has been locked for modifications. Move any configuration code earlier in the configuration pipeline");
            }
        }
        ...
        void EnsureWriteEnabled(string key)
        {
            if (locked)
            {
                throw new InvalidOperationException($"Unable to set the value for key: {key}. The settings has been locked for modifications. Move any configuration code earlier in the configuration pipeline");
            }
        }
